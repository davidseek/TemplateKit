...
class TextLayout {
    ...
    private func applyProperties() {
        ...
        let _attributes: [NSAttributedStringKey: Any] = [
            ...
            NSAttributedStringKey.foregroundColor: properties.textStyle.color ?? .white,
            NSAttributedStringKey.paragraphStyle: paragraphStyle
        ]
        
        textStorage.setAttributedString(NSAttributedString(string: properties.text ?? "", attributes: _attributes))

...
public struct TableProperties: Properties {
    ...
    public mutating func merge(_ other: TableProperties) {
        ...
        TemplateKit.merge(&tableViewDelegate, other.tableViewDelegate)
        TemplateKit.merge(&tableViewDataSource, other.tableViewDataSource)
        TemplateKit.merge(&eventTarget, other.eventTarget)
        TemplateKit.merge(&isEditing, other.isEditing)
